...
\begin{figure}
  \begin{subfigure}{6cm}
    \centering\includegraphics[width=5cm]{approach1.jpeg}
    \caption{Pre-Augmentation}
  \end{subfigure}
  \begin{subfigure}{6cm}
    \centering\includegraphics[width=5cm]{approach2.jpeg}
...
\begin{figure}[h!]
\centering
  \includegraphics[width=0.8\textwidth]{proposedmethod.jpeg}
...
\begin{figure}
  ...
  \end{subfigure}
  \begin{subfigure}{6cm}
    \centering\includegraphics[width=5cm]{accuracyrandomInsertionA1.jpeg}
...
\begin{figure}[h!]
\centering
  \includegraphics[width=0.8\textwidth]{dataset.jpeg}
...
\begin{figure}[h!]
\centering
  \includegraphics[width=0.8\textwidth]{accuracyproposed.jpeg}
